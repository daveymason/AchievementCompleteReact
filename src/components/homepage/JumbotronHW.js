...
const JumbotronTO = () => {
  return (
    <div class="anchorDiv" id="features">
      <Container fluid>
        <div className="container pb-3">
          <div className="row row-content align-items-center">
            ...
            <div className="col-sm-7">
              <h3>Structure</h3>
              <p>
                We use a structured approach to help you achieve your goal, with
                a mix of external resources, regular testing and self validated
                learning.
              </p>
            </div>
          ...
          <div className="row row-content align-items-center pb-0 mb-0">
            ...
            <div className="col-sm-7">
              <h3>Community</h3>
              <p>
                With a dedicated, supportive and caring community once you
                achieve your goal you'll be delighted to share your results and
                advice with others.
              </p>
            </div>
            <div className="col text-center display-4 d-none d-md-block d-lg-block d-xl-block">
