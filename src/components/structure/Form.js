    ...
    <div className="row my-sm-4 text-center">
      ...
      <div className="col text-center">
        <button type="button" className="btn animateInLeft" title="cntButtonEmail">
          <a href="mailto:daveymason@outlook.com" target="_blank" data-toggle="tooltip" data-placement="bottom" data-html="true" title="Click or Tap to E-mail!">
          <i className="far fa-envelope display-1"></i></a>
        </button>
      </div>
      <div className="col text-center">
        <button type="button" className="btn animateInLeft" title="cntButtonEmail">
            <a href="tel:123-456-7890" target="_blank" data-toggle="tooltip" data-placement="bottom" data-html="true" title="Click or Tap to Call!">
